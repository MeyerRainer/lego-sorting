...
class CameraCalibration:
    ...
    def calibrate_camera(self):
        ...
        pickle.dump((self.camera_matrix, self.distortion_coefficients), open("calibration.pkl", "wb"))
        pickle.dump(self.camera_matrix, open("cameraMatrix.pkl", "wb"))
        pickle.dump(self.distortion_coefficients, open("dist.pkl", "wb"))
